...
### 1.6. Steering Committee Vacancies

In the event that a Steering Committee Member resigns or is otherwise unable to fulfill their duties, the vacancy shall be handled as follows:

* **Interim Appointment:** The Steering Committee may designate a short-term replacement to fill the vacant seat via a standard Steering Committee vote. 
    * If the vacancy is due to a planned resignation, the resigning member is encouraged to participate in the vote to designate their successor.
    * If a member is unresponsive or has "gone dark" for a period exceeding 30 days without prior notice, the Steering Committee may proceed with a vote to appoint a replacement without that member’s participation.
* **Term of Appointment:** The appointed replacement shall serve until the next election.
